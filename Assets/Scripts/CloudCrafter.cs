...
public class CloudCrafter : MonoBehaviour {
	...
	void Awake() { 
		...
		for (int i=0; i<numClouds; i++) { 
			...
			// Smaller clouds should be further away [imitating perspective]
	...
	void Update() { 
		...
		foreach (GameObject cloud in cloudInstances) { 
			...
			// Move larger clouds faster [since larger clouds are closer to the
			// camera, this will imitate perspective motion]
